    ...
    context("Query activities", () => {
        context("builds correct request for QUERY", () => {
            ...
            it("for getActivitiesWhereStartTimeGreaterThan", async () => {
                ...
                await dynamoDbService.getActivitiesWhereStartTimeGreaterThan("2020-07-29", "2020-07-29T10:00:40.561Z");
        ...
        context("builds correct request for GET", () => {
            ...
            // Mock once
            let stub: any = null;
            AWS.DynamoDB.DocumentClient.prototype.get = jest.fn().mockImplementation((params: DocumentClient.Get) => {
                return {
                    promise: () => {
                        stub = params;
                        return Promise.resolve([]);
