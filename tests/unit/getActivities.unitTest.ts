...
describe('getActivities', () => {
  // @ts-ignore
  const getActivityService: GetActivityService = new GetActivityService(
    new DynamoDBMockService() as any
  );
  context('when no data is returned from database', () => {
    it('should throw error', () => {
      ...
      return getActivityService.getActivities(event).catch((error: HTTPResponse) => {
